...
function interpAry(t, t1, t2, val1, val2, clip, mthd){    // Accepts Arrays or nonArrays  // Returns array of longest length of input arrays
  var tAry = forceAry(t),  t1Ary = forceAry(t1),  t2Ary = forceAry(t2),  val1Ary = forceAry(val1),  val2Ary = forceAry(val2),  clipAry = forceAry(clip),  mthdAry = forceAry(mthd);
  var lngstLngth = lngstAry([tAry, t1Ary, t2Ary, val1Ary, val2Ary, clipAry, mthdAry]);
  tAry = forceAryLength(tAry, lngstLngth, clip= false);  t1Ary = forceAryLength(t1Ary, lngstLngth, clip= false);  t2Ary = forceAryLength(t2Ary, lngstLngth, clip= false);  val1Ary = forceAryLength(val1Ary, lngstLngth, clip= false);  val2Ary = forceAryLength(val2Ary, lngstLngth, clip= false);  clipAry = forceAryLength(clipAry, lngstLngth, clip= false);  mthdAry = forceAryLength(mthdAry, lngstLngth, clip= false);
